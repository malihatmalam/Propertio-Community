...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('page.article.cms.category.index', compact('category'));
    }
    ...
    {
        return view('page.article.cms.category.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('page.article.cms.category.edit', compact('category'));
