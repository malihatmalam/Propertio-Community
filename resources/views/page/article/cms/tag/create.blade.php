        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4>Tambah Tag Artikel</h4>
                        <span>Management list Tag artikel - Tambah Tag</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="">Tambah Tag Artikel</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="page-body">
        ...
        <div class="card">
            <div class="card-block">
                ...
                <div class="m-b-20">
                    <h4 class="sub-title">Tambah Tag Artikel</h4>
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 col-xl-12">
                              <form action="{{ route('tag.store') }}" method="POST">
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="form-group">
                                            <button type="submit" class="btn btn-primary btn-block">Tambah Tag</button>
                                            </div>
                                        </div>
                                   </div>
