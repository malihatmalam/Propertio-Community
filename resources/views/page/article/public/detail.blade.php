               ...
               <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                    <div class="page-wrapper">
                         <div class="blog-title-area">
                              ...
                              <span class="color-green"><a href="{{ route('blog.category.list', $data->category->name ) }}" title="">{{ $data->category->name }}</a></span>

                              <h3>{{ $data->title }}</h3>

                              <div class="blog-meta big-meta">
                              <small><a href="" title="">{{ $data->date }}</a></small>
                              <small><a href="" title="">oleh {{ $data->users->userData->fullname }}</a></small>
                              <small><a href="#" title=""><i class="fa fa-calendar-o"></i> hanya <strong>{{ $data->read_duration }} menit</strong> untuk dibaca</a></small>
                              </div><!-- end meta -->
                         ...
                         <div class="single-post-media">
                              <img src="{{ asset( $data->image_cover ) }}" alt="" class="img-fluid">
                         </div><!-- end media -->
                         ...
                         <div class="custombox authorbox clearfix">
                              ...
                              <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                   <img src="http://propertio-dev.apps.test/data/image/users/{{ $data->users->userData->picture_profile }}" alt="" class="img-fluid rounded-circle"> 
                              </div><!-- end col -->

                              <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                   <h4><a href="#">{{ $data->users->userData->fullname }}</a></h4>
               ...
               <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                    <div class="sidebar">
                         <div class="widget">
                              ...
                              <form class="form-inline search-form" action="{{route('blog.cari')}}" method="get">
